...
import type { EntryOption, TableGroup } from "./useAttachmentABData";
...
export default function AttachmentABTableSection({
  table, tableIndex, entries,
  onRemove, onUpdateTitle, onBlurTitle, onAddRow, onRemoveRow, onEntryChange,
}: Props) {
